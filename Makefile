...
OFILES = main.o mylib.o spritesheet.o objects.o logic.o plot.o levels.o text.o font.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h spritesheet.h objects.h plot.h logic.h levels.h text.h
